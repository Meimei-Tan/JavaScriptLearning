...
/*
* Location
*   -直接打印location，可以获取到地址栏信息，当前页面的完整路径
*   -如果直接将location属性修改为一个完整的路径，则效果等同于超链接，并且会生成历史记录
* location对象方法：
* assign()加载新的文档，即跳转到其他页面
* reload()重新加载当前文档，即刷新页面 参数为boolean 表示是否强制刷新缓存页面
* replace()用新的文档替换当前文档，会跳转到新的页面，但不会生成历史记录，也不能用回退按钮回退
* */